...
GITHUB REPOSITORY: https://github.com/efigueira/build-ml-pipeline-for-short-term-rental-prices

WEIGHT AND BIASES PROJECT: [https://wandb.ai/team-figurilla/nyc_airbnb](https://wandb.ai/team-figurilla/nyc_airbnb)
...
```
git clone https://github.com/efigueira/build-ml-pipeline-for-short-term-rental-prices.git
```
